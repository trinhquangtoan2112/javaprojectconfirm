...
VALUES (10, 'Tung', 'Dang Thanh', '1989-05-06', 'MALE', '0123456789', 'someone@email.com', 'user8',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:29.231', '2024-04-18 09:56:29.231'),
       (11, 'Trung', 'Nguyen Khac', '1990-06-07', 'MALE', '0123456789', 'someone@email.com', 'user9',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:30.136', '2024-04-18 09:56:30.136'),
       (12, 'Kien', 'Truong Hai', '1991-07-09', 'MALE', '0123456789', 'someone@email.com', 'user10',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:30.6', '2024-04-18 09:56:30.6'),
       (13, 'Quan', 'Vu Hong', '1992-08-11', 'MALE', '0123456789', 'someone@email.com', 'user11',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:30.963', '2024-04-18 09:56:30.963'),
       (23, 'Nguyen', 'Nguyen Trung', '2003-03-12', 'MALE', '0123456789', 'someone@email.com',
        'user21', '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:22.366', '2024-04-18 09:56:22.366'),
       (24, 'Huy', 'Dang', '2001-04-23', 'MALE', '0123456789', 'someone@email.com', 'user23',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'INACTIVE',
        'USER', '2024-04-18 09:56:23.573', '2024-04-18 09:56:23.573'),
       (25, 'Khang', 'Minh', '2002-05-25', 'MALE', '0123456789', 'someone@email.com', 'user24',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'NONE',
        'USER', '2024-04-18 09:56:24.091', '2024-04-18 09:56:24.091'),
       (26, 'Ngan', 'Le', '2004-02-15', 'MALE', '0123456789', 'someone@email.com', 'user25',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:21.536', '2024-04-18 09:56:21.536'),
       (27, 'Thuy', 'Thuy', '2003-05-20', 'FEMALE', '0123456789', 'someone@email.com', 'user26',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:23.06', '2024-04-18 09:56:23.06'),
       (14, 'Tu', 'Tran Ngoc', '1993-09-12', 'MALE', '0123456789', 'someone@email.com', 'user12',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:31.3', '2024-04-18 09:56:31.3');
INSERT INTO tbl_user (id, first_name, last_name, date_of_birth, gender, phone, email, username, "password", status,
                      "type", created_at, updated_at)
VALUES (15, 'Tuan', 'Dang Dinh', '1992-10-13', 'MALE', '0123456789', 'someone@email.com', 'user13',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-15 21:54:04.258', '2024-04-15 21:54:04.258'),
       (16, 'Hung', 'Nguyen Quoc', '1994-10-14', 'MALE', '0123456789', 'someone@email.com', 'user14',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-15 21:57:15.934', '2024-04-15 21:57:15.934'),
       (17, 'Que', 'Mai Ngoc', '1995-11-11', 'MALE', '0123456789', 'someone@email.com', 'user15',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'NONE',
        'USER', '2024-04-15 22:02:26.532', '2024-04-16 21:14:05.098'),
       (18, 'Binh', 'Tran Tu', '1996-12-15', 'MALE', '0123456789', 'someone@email.com', 'user16',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-15 22:05:00.438', '2024-04-15 22:05:00.438'),
       (19, 'Thanh', 'Nguyen Hai', '1997-01-16', 'FEMALE', '0123456789', 'someone@email.com', 'user17',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:25.034', '2024-04-18 09:56:25.034'),
       (20, 'Hoa', 'Pham Ngoc', '1998-07-10', 'FEMALE', '0123456789', 'someone@email.com', 'user18',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:26.215', '2024-04-18 09:56:26.215'),
       (2, 'Admin', 'Sub', '1981-06-05', 'MALE', '0123456789', 'admin@email.com', 'admin',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'ADMIN', '2024-04-18 09:56:24.587', '2024-04-18 09:56:24.587'),
       (3, 'Manager', 'Mai', '1982-07-24', 'FEMALE', '0123456789', 'someone@email.com', 'manager',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:58:07.611', '2024-04-18 09:58:07.611'),
       (4, 'Nam', 'Dinh Van', '1983-06-08', 'MALE', '0123456789', 'someone@email.com', 'user1',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:25.435', '2024-04-18 09:56:25.435'),
       (5, 'Dinh', 'Pham Quang', '1984-02-28', 'MALE', '0123456789', 'someone@email.com', 'user2',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:25.804', '2024-04-18 09:56:25.804');
INSERT INTO tbl_user (id, first_name, last_name, date_of_birth, gender, phone, email, username, "password", status,
                      "type", created_at, updated_at)
VALUES (6, 'Oanh', 'Nguyen Thi Kim', '1985-01-01', 'FEMALE', '0123456789', 'someone@email.com',
        'user3', '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:58:08.138', '2024-04-18 09:58:08.138'),
       (21, 'Sam', 'Trinh Van', '1999-01-19', 'FEMALE', '0123456789', 'someone@email.com', 'user19',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:26.88', '2024-04-18 09:56:26.88'),
       (7, 'Dung', 'Nguyen Thi', '1986-02-02', 'MALE', '0123456789', 'someone@email.com', 'user5',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:26.542', '2024-04-18 09:56:26.542'),
       (8, 'Chi', 'Pham Thi', '1987-03-04', 'FEMALE', '0123456789', 'someone@email.com', 'user6',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:58:08.589', '2024-04-18 09:58:08.589'),
       (9, 'Dung', 'Tran Thuy', '1988-04-05', 'MALE', '0123456789', 'someone@email.com', 'user7',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:28.438', '2024-04-18 09:56:28.438'),
       (22, 'My', 'Kieu', '2000-02-22', 'FEMALE', '0123456789', 'someone@email.com', 'user10',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-18 09:56:31.622', '2024-04-18 09:56:31.622'),
       (28, 'Tay', 'Java', '2003-06-05', 'MALE', '0123456789', 'someone@email.com', 'user22',
        '$2a$10$OvJyuXkBfkzNKalExgOu8epWOv5wtUSp2HIKKsENxyjatBU9lgfKC', 'ACTIVE',
        'USER', '2024-04-20 06:00:46.115', '2024-04-20 06:00:46.115'),
       (1, 'SysAdmin', 'Sys', '1980-06-05', 'MALE', '0123456789', 'sysadmin@email.com', 'sysadmin',
        '$2a$10$y.cFBNzeymlgGpNJpm2lk.y8xrIONOY/vZHwX9vAquF7Y3ZFPYX.q', 'ACTIVE',
        'OWNER', '2024-04-18 09:58:07.169', '2024-08-05 11:10:30.886'),
       (29, 'Tây', 'Java', '2003-06-05', 'MALE', '0123467891', 'admin222@email.com', 'tayjava1',
        '$2a$10$y.cFBNzeymlgGpNJpm2lk.y8xrIONOY/vZHwX9vAquF7Y3ZFPYX.q', 'ACTIVE',
        'USER', '2024-08-06 10:08:28.483', '2024-08-06 10:08:28.483'),
       (94, 'Nam', 'Nguyễn', '2024-11-14', 'MALE', '1234567890', 'namnguyen@email.com', 'namnguyen',
        NULL, 'NONE', 'OWNER', '2024-11-15 17:16:44.743',
        '2024-11-15 17:16:44.743');
INSERT INTO tbl_user (id, first_name, last_name, date_of_birth, gender, phone, email, username, "password", status,
                      "type", created_at, updated_at)
VALUES (96, 'Nam', 'Nguyễn', '2024-11-14', 'MALE', '1234567890', 'namnguyen@email.com', 'namnguyen',
        NULL, 'NONE', 'OWNER', '2024-11-15 17:19:40.244',
        '2024-11-15 17:19:40.244'),
       (105, 'ABC-TEST', 'Nguyễn', '2024-11-14', 'MALE', '1234567890', 'namnguyen@email.com',
        'namnguyen88888', '$2a$10$diRLQ.ZCrVnXVF7iTxfXYuK2iVb40QD73XU30DS2XOxuyI1P9Cdne',
        'INACTIVE', 'OWNER', '2024-11-16 10:18:30.129',
        '2024-11-16 10:28:04.028'),
       (103, 'TEST1', 'Nguyễn1', '2024-11-20', 'MALE', '556777', 'test@email.com', 'test',
        '$2a$10$REmI6z6zYOFZWMlVbguge.x/bftXPx7BBNx3GUlxg53hStV0e9Bdm', 'ACTIVE',
        'OWNER', '2024-11-16 06:29:05.425', '2024-11-16 06:55:23.335'),
       (107, 'aaa', 'string', '2024-11-27', 'MALE', 'string', 'someone@email.com', 'string', NULL,
        'NONE', 'OWNER', '2024-11-27 12:33:50.587',
        '2024-11-27 12:33:50.587'),
       (93, 'Nam', 'Nguyễn', '2024-11-14', 'MALE', '1234567890', 'namnguyen@email.com', 'namnguyen',
        NULL, 'NONE', 'OWNER', '2024-11-15 17:13:21.132',
        '2024-11-15 17:13:21.132'),
       (95, 'Nam', 'Nguyễn', '2024-11-14', 'MALE', '1234567890', 'namnguyen@email.com', 'namnguyen',
        NULL, 'NONE', 'OWNER', '2024-11-15 17:19:06.275',
        '2024-11-15 17:19:06.275'),
       (97, 'Nam11111111', 'Nguyễn', '2024-11-14', 'MALE', '1234567890', 'namnguyen@email.com',
        'namnguyen88888', NULL, 'NONE', 'OWNER', '2024-11-15 17:21:32.892',
        '2024-11-15 17:21:32.892'),
       (102, 'ALOHA......', 'Nguyễn', '2024-11-14', 'MALE', '1234567890', 'namnguyen@email.com',
        'namnguyen88888', NULL, 'NONE', 'OWNER', '2024-11-16 06:28:10.779',
        '2024-11-16 06:28:10.779'),
       (104, 'BCD-Update', 'Update', '2024-11-20', 'MALE', '556777', 'Update@email.com', 'Update',
        NULL, 'NONE', 'OWNER', '2024-11-16 10:06:48.963',
        '2024-11-16 10:07:50.757'),
       (106, 'Tay', 'Java', '2024-11-27', 'MALE', 'string', 'tay@java.vn', 'string', NULL,
        'NONE', 'OWNER', '2024-11-27 11:23:25.72', '2024-11-27 11:23:25.72');
INSERT INTO tbl_user (id, first_name, last_name, date_of_birth, gender, phone, email, username, "password", status,
                      "type", created_at, updated_at)
VALUES (110, 'ABC-TEST', 'Nguyễn', '2024-11-14', 'MALE', '1234567890', 'luongquoctay87@gmail.com',
        'namnguyen88888', NULL, 'NONE', 'OWNER', '2024-12-09 23:25:03.311',
